...
export function AuthPage({ mode }: { mode: "login" | "signup" }) {
  ...
  return <main className="grid min-h-screen bg-background lg:grid-cols-[0.85fr_1.15fr]">
    <section className="relative hidden overflow-hidden bg-sidebar p-12 text-sidebar-foreground lg:flex lg:flex-col">
      <Link to="/" aria-label="Go to FlowForge landing page" className="flex w-fit items-center gap-3 rounded-lg transition-opacity hover:opacity-85 focus:outline-none focus:ring-2 focus:ring-sidebar-primary focus:ring-offset-2 focus:ring-offset-sidebar"><div className="grid size-10 place-items-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground"><GitBranch /></div><div><p className="font-semibold text-sidebar-accent-foreground">FlowForge ERP</p><p className="text-xs text-sidebar-foreground/60">ERPilot AI</p></div></Link>
