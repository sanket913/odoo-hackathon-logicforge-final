...
export const api = {
  ...
  erpilot: {
    ...
    businessHealth: () => request<unknown>("/erpilot/business-health"), orderFeasibility: (data: unknown) => request<unknown>("/erpilot/order-feasibility", { method: "POST", body: data }), whatIf: (data: unknown) => request<unknown>("/erpilot/what-if", { method: "POST", body: data }), rootCause: (data: unknown) => request<unknown>("/erpilot/root-cause", { method: "POST", body: data }), vendorRanking: () => request<unknown>("/erpilot/vendor-ranking"), bottlenecks: () => request<unknown>("/erpilot/bottlenecks"), digitalTwin: () => request<unknown>("/erpilot/digital-twin"), procurementPrediction: () => request<unknown>("/erpilot/procurement-prediction"),
  },
